...
COMMENT ON COLUMN barcodes.run.sequenced_on IS 'When the sequencing happened';

COMMENT ON COLUMN barcodes.run.filepath IS 'Where the sequencing results are.';
